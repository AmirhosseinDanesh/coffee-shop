        ...
        <>
            <div className='p-5 bg-white dark:bg-zinc-700 shadow-normal rounded-2xl'>
                ...
                <div className="p-4 flex flex-col justify-between items-center">
                    ...
                    <div className='flex text-xl items-center justify-start gap-x-1 text-gray-950 dark:text-gray-200'>
                    ...
                    <div className='flex w-full justify-between items-center text-gray-950 dark:text-gray-200'>
                        <div className="flex items-center px-3 py-2 text-sm text-center text-white rounded-full bg-zinc-800" onClick={() => {
                            console.log(pro._id)
                        }}>
                        ...
                        <span className='flex'>
                            {
                                Array(5 - pro.courseAverageScore).fill(0).map(star => (
                                    <svg key={crypto.randomUUID()} className="w-5 h-5 text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                            ...
                            }
                            {
                                Array(pro.courseAverageScore).fill(0).map(star => (
                                    <svg key={crypto.randomUUID()} className="w-5 h-5 text-yellow-500 fill-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                                    </svg>
                                ))
                            }
