  ...
  return (
    <>
      ...
      <div className='flex md:hidden items-center justify-between bg-white dark:bg-zinc-700 h-16 px-4'>
        ...
        {
          headerSidebar && <>
            <div className='fixed top-0 right-0 w-64 min-h-screen bg-white dark:bg-zinc-700 pt-3 px-4 z-20 backdrop:blur-lg'>
              {/* LOGO */}
              ...
              <div>
                <ul className=' text-zinc-600 dark:text-white space-y-6 '>
                  <li className=''>
                    <NavLink to="/" className={({ isActive }) => (isActive) ? ("flex items-center bg-orange-200/20 text-orange-300 mb-4 h-10 rounded-md gap-x-2 pr-2") : ("flex items-center mb-4 h-10 pr-0 rounded-md gap-x-2 pr-2")} >
                  ...
                  <li className='flex items-center justify-between'>
                    <NavLink to="/shop" className="flex items-center gap-x-2 pr-2">
                      <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
                  ...
                  <li>
                    <NavLink to="/articles" className={({ isActive }) => (isActive) ? ("flex items-center bg-orange-200/20 text-orange-300 mb-4 h-10 rounded-md gap-x-2 pr-2") : ("flex items-center mb-4 h-10 pr-0 rounded-md gap-x-2 pr-2")} >
                      <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                      </svg>
                      مقالات
              ...
              {/* Info */}
              <div className='space-y-6 px-2.5 pt-5 mt-6 border-t border-t-gray-100 dark:border-t-white/10'>
                <div>
                  {
                    auth.isLoggedIn ? (
                      <>
