        ...
        <>
            ...
            <Slider >
                <SwiperSlide className='overflow-y-visible' >
                    <div className="bg-slide-1-M md:bg-slide-2-D relative xs:h-auto xs:aspect-[2/1] h-[250px] bg-no-repeat bg-cover bg-[center_top]">
            ...
            <div className='container grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3.5 md:gap-5 child:h-[200px] mt-10'>
                {
                    allProducts.map((pro) => (
